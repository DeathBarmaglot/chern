...
//images folder
var im='https://raw.githubusercontent.com/DeathBarmaglot/chern/main/images/';
...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'date',
                type: 'image',
                rect: ['7px', '-4px','48px','56px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"date.png",'0px','0px']
            },
            {
                id: 'time',
                type: 'image',
                rect: ['1px', '-4px','89px','103px','auto', 'auto'],
            ...
            },
            {
                id: 'Opticom',
                type: 'image',
                rect: ['187px', '10px','101px','42px','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"Opticom.png",'0px','0px']
            }],
            symbolInstances: [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid121", tween: [ "style", "${_Opticom}", "opacity", '1', { fromValue: '0'}], position: 1952, duration: 250, easing: "easeInOutElastic" },
